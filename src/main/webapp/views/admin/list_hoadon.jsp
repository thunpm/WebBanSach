...
<head>
    <meta charset="utf-8">
    <title>Quản lý hóa đơn chủ Admin</title>
						    ...
						    <table class="">
								...
								<c:forEach items="${listHoaDon}" var="hoaDon">
									<tr>
										...
										<td>
											<a class="btn btn-danger" href="${root}/admin/quanLyHoaDon/detail?idDonHang=${hoaDon.id}">Chi tiết</a>
										</td>
										<td>
											<a class="btn btn-danger" href="${root}/admin/quanLyHoaDon/delete?idDonHang=${hoaDon.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');">Xóa</a>
										</td>
									</tr>	
								</c:forEach>	
							</table>
