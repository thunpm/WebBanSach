...
<head>
    <meta charset="utf-8">
    <title>Đặt lại mật khẩu cho khách hàng</title>
    	...
    	<c:if test="${! empty sessionScope.admin}">
	    	<div class="menu">
	   		...
	   		<div class="khoi">
		   		...
		   		<div class="content">
		   			<h5>Đặt lại mật khẩu cho khách hàng ${idKhachHang}</h5>
			    	<p style="color: red;">${message}</p>
			        <form action="${root}/admin/quanLyKhachHang/updated" method="POST">
